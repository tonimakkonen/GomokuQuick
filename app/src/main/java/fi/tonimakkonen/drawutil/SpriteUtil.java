...
public class SpriteUtil {
	...
	public void draw(GL10 gl, float cx, float cy, float width, float height) {
		...
		fb_vp.put(ll_x); fb_vp.put(ll_y); fb_vp.put(0.0f);
		fb_vp.put(lr_x); fb_vp.put(lr_y); fb_vp.put(0.0f);
		fb_vp.put(tl_x); fb_vp.put(tl_y); fb_vp.put(0.0f);
		fb_vp.put(tr_x); fb_vp.put(tr_y); fb_vp.put(0.0f);
		fb_vp.position(0);
	...
	public void setColorUniform(float sr, float sg, float sb, float sa) {
		...
		fb_vc.put(sr); fb_vc.put(sg); fb_vc.put(sb); fb_vc.put(sa);
		fb_vc.put(sr); fb_vc.put(sg); fb_vc.put(sb); fb_vc.put(sa);
		fb_vc.put(sr); fb_vc.put(sg); fb_vc.put(sb); fb_vc.put(sa);
		fb_vc.put(sr); fb_vc.put(sg); fb_vc.put(sb); fb_vc.put(sa);
		fb_vc.position(0);
