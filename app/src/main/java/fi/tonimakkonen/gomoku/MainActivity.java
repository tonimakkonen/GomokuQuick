        ...
        switch (win) {
            ...
            case 0: //No win, place mark, X or O
                ...
                // Human (but not only) playing, show name
                    ...
                    if (mark == 1)
                        st = getResources().getString(R.string.ab_human_x) + " (" + name + ")";
                    if (mark == 2)
                        st = getResources().getString(R.string.ab_human_o) + " (" + name + ")";
                }
                // AI (placING not place)
                    ...
                    if (mark == 1)
                        st = getResources().getString(R.string.ab_ai_x) + " (" + name + ")";
                    if (mark == 2)
                        st = getResources().getString(R.string.ab_ai_o) + " (" + name + ")";
                }
