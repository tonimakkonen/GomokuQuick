...
public class GoRenderer implements Renderer {
	...
	public float getHexCoordX(int ix, int iy) { return 40.0f*HexCalc.getTileCenterX(ix, iy); }
	public float getHexCoordY(int ix, int iy) { return 40.0f*HexCalc.getTileCenterY(ix, iy); }
